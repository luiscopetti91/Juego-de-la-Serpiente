  ...
  let game = {
    ...
    loop: function () {
      ...
      if(!stopped) {
        ...
        ctx.fillText("(esc) reiniciar", 24, 356);
        ctx.fillText("(espacio) pausar", 24, 374);
      }
      ...
      if(stopped) {
        ...
        ctx.fillText("Precione una tecla para iniciar...", 24, 374);
        ctx.fillText("Creado por Luis Copetti...", 29, 110);

      }

      ctx.fillStyle = 'white';
      ctx.font = "bold small-caps 16px Helvetica";
      ctx.fillText("puntos: " + points, 288, 40);
      ctx.fillText("Maximo: " + pointsMax, 292, 60);
